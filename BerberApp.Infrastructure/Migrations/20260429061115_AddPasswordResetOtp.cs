...
namespace BerberApp.Infrastructure.Migrations
{
    ...
    public partial class AddPasswordResetOtp : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"ALTER TABLE ""Tenants"" ADD COLUMN IF NOT EXISTS ""NotificationPhone"" text;");
            ...
            migrationBuilder.Sql(@"
                CREATE TABLE IF NOT EXISTS ""Subscriptions"" (
                    ...
                    CONSTRAINT ""FK_Subscriptions_Tenants_TenantId"" FOREIGN KEY (""TenantId"")
